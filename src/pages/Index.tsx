...
const menuCategories = [
  {
    ...
    emoji: '🌯',
    items: [
      { name: 'Классическая Шаурмама', price: 350, description: 'Курица, овощи, фирменный соус', popular: true },
      { name: 'Острая Шаурмама', price: 380, description: 'Курица, перец халапеньо, острый соус' },
      { name: 'Мясная Шаурмама', price: 420, description: 'Говядина, овощи, чесночный соус' },
      { name: 'Вегетарианская Шаурмама', price: 320, description: 'Фалафель, овощи, хумус' },
    ]
  },
  {
    id: 'burgers',
    ...
    emoji: '🍔',
    items: [
      { name: 'Классический бургер', price: 380, description: 'Говяжья котлета, сыр, овощи' },
      { name: 'Двойной бургер', price: 520, description: 'Две котлеты, двойной сыр, бекон', popular: true },
      { name: 'Чикен бургер', price: 350, description: 'Куриная котлета, сыр, соус' },
    ]
  },
  {
    id: 'pita',
