...
const menuCategories = [
  ...
  },
  {
    ...
    emoji: '🍴',
    items: [
      { name: 'Соус 1000 островов 40гр.', price: 50, description: '40 гр.' },
      { name: 'Соус барбекю 40гр.', price: 50, description: '40 гр.' },
      { name: 'Соус острый 40гр.', price: 50, description: '40 гр.' },
      { name: 'Соус сырный 40гр.', price: 50, description: '40 гр.' },
      { name: 'Соус чесночный 40гр.', price: 50, description: '40 гр.' },
      { name: 'Кетчуп 40гр.', price: 50, description: '45 гр.' },
    ]
  }
];
